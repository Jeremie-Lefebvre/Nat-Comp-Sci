...
double FREQUENCY[S];//stimulation frequency
double AMPLITUDE[S];//stimulation amplitude
...
//stimulation frequency to be evaluated	
FREQUENCY[0]=  0.1;
FREQUENCY[1] = 0.5;
FREQUENCY[2] = 1;
FREQUENCY[3] = 5;
...
for(int s1=0;s1<S;s1++)
{
	...
	{
			AMPLITUDE[s2] = 0.1;//0.01+2*s2/((double)S);
